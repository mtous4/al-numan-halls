...
export const TEMPLATES = [
  ...
  },
  {
    ...
    previewImage: '/images/templates/emerald-botanica.jpg',
    sections: ['cover', 'couple', 'family', 'date', 'countdown', 'schedule', 'gallery', 'location', 'rsvp', 'messages', 'qrcode'],
    active: true,
  },
  {
    ...
    previewImage: '/images/templates/blush-romance.jpg',
    sections: ['cover', 'couple', 'family', 'date', 'countdown', 'schedule', 'gallery', 'location', 'rsvp', 'messages', 'qrcode'],
    active: true,
  },
  {
    ...
    previewImage: '/images/templates/midnight-royale.jpg',
    sections: ['cover', 'couple', 'family', 'date', 'countdown', 'schedule', 'gallery', 'location', 'rsvp', 'messages', 'qrcode'],
    active: true,
  },
  {
    ...
    previewImage: '/images/templates/crimson-velvet.jpg',
    sections: ['cover', 'couple', 'family', 'date', 'countdown', 'schedule', 'gallery', 'location', 'rsvp', 'messages', 'qrcode'],
    active: true,
  },
  {
